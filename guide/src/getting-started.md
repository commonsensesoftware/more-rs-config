...
This includes all features _except_ the **async** feature. The **async** feature intersects with all other features.
If you would like all features with asynchronous support use:
...
Configuration is a common requirement of virtually any application and can be performed using one or more configuration
providers. Configuration providers read configuration data from key-value pairs using a variety of configuration sources:
