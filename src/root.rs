...
pub trait ConfigurationRoot: Configuration + Debug {
    ...
    /// Downcasts the [ConfigurationRoot](trait.ConfigurationRoot.html) to a [Configuration](trait.Configuration.html).
